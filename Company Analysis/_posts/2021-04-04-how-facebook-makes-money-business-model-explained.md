...
**Facebook's [market share](https://www.emarketer.com/content/google-ad-revenues-drop-first-time){:target="_blank"} on ad revenue in the US in 2019 was 23%,** making in it the second biggest player after Google with 32% market share. Compared to Google, Facebook experienced much higher growth in 2019. **Total size of US market was around 130bn anually.**
...
Similar to Google, Facebook's biggest competitor for ad dollars, **price that businesses pay for ads on Facebook is determined by action where advertisers compete with each other.** To win the action it is not only about price advertisers offer to Facebook when user clicks on their add. 

It would not make much sense for Facebook to show ad campaigns that offered the highest price per click when people would not click on those ads very often. Therefore, an auction considers how often users will click on ads, and it is designed to prefer advertisements that will make the most money to Facebook.
...
**Advertisers are Facebook's primary customers, but Facebook's relationship with them, mainly the bigger ones, is not a love story. They quarreled a lot in the past about Facebook's flawed ad performance tracking, and most recent issues were around advertisers pushing Facebook to do more about hateful and content on Facebook.**
...
When many household name companies announce that their will stop advertising on Facebook, as we could experience from time to time, it does not significantly affect Facebook's revenue. 
...
The idea is that it will be a much seamless user experience, leading to more people who click on a particular ad ending up purchasing the product. That will drive prices per ad up and increase Facebook revenue.
...
Initially, Facebook planned to make money advertising on WhatsApp, similar to what Facebook did in Facebook Messenger, but Facebook scrapped these plans. Currently, Facebook says that it will pursue a different business model for WhatsApp.
...
Given how quickly users of Oculus are growing, it might become significant enough to attract more gaming developers to make Oculus another gaming platform next o Xbox, PlayStation, and Nintendo.
...
- Facebook charges a **subscription fee** for its **Workplace** tool, which can be best described as private Facebook to be used by companies for internal communication.
...
**Number of people who "shame" Facebook online or offline in everyday conversations is mind gobbling. Unsurprisingly, recent [WSJ rating](https://www.wsj.com/articles/warning-signs-in-the-best-managed-companies-11607785916){:target="_blank"} of US companies showed Facebook as the worst one in the customers' satisfaction among the top 100 in their raking.** 
...
Facebook will need to consistently work on this for years before expecting that we take their privacy commitment seriously. And I agree that this might take a decade, even if Facebook focuses on it.
...
**Privacy:** Mark Zuckerberg claims that he wants Facebook to build a strong reputation for privacy over the next decade. This, in my view, is just an empty statement that is contrary both to Facebook's business model and also Facebook's recent actions, where Facebook is openly pushing for less choice for users when it comes to privacy. The only other explanation is that Marks's definition of "privacy" very much differs from what usually people understand by it
...
- **Content moderation:** Big part of "toxicity" around Facebook is the presence of hateful content and misinformation. Facebook is ramping up its effort in content moderation, making sure this content is taken down and that certain content is not actively promoted to people's feeds. But let's face it, this is an impossible task.
    ...
    The issue here is that different groups of people have different ideas to draw a line for "toxic" content. Some groups advocate that Facebook is doing far too little and should broaden the range of content that is not allowed on the platform. On the other hand, some groups warn that Facebook is taking down too much content. 
...
COVID-19 pandemic that started in 2020 helped speed up this user's growth, but Facebook's users would still be growing at least in the high single digits even without it. For comparisons in 2019, user growth was 8%.  

Individual people might be leaving Facebook, but **there are still more new people coming in than going out, even in US**, which is good news for Facebook's business. Some people who started using Facebook more during a pandemic in the US dropped the app later, but this small drop did not offset a significant increase during the year. 

And it is not just the number of users. Facebook is also doing well in growing its revenue and profits. It looks that advertisers are not leaving Facebook either. Facebook was able to **grow revenue by 22% in 2020 to  $86bn**.  This was despite weak performance during the fists half of 2020 as the pandemic started. For comparison, Facebook revenue grew by 27% in  2019.

**Putting it all together, it seems that although there is so much toxicity around Facebook and so much bad PR, at the end of the day, its users continue using it, and Facebook can attract new users both in the US and especially in Asia. Advertisers, primarily small businesses, are sticking with Facebook too. That suggests that its future does not have to be so bleak as the "toxic" aura around it suggests.** 
That does not mean that there are not some challenges ahead that Facebook will need to navigate carefully.

One challenge Facebook is facing **weaker position among younger users**. Facebook is still an important player for younger users thanks to its Instagram app, but its position is not so dominant as among the older population. In the US, the most popular social network app among teenagers is Snapchat, followed closely by Instagram.  
...
Facebook already launched one important growth initiative in 2020. The company **implemented e-commerce functionality across Facebook, Instagram, and WhatsApp.** This will allow small businesses to offer their products for purchase right within a family of Facebook apps, including the ability to accept payments. 
...
In the end, I have also to mention the general trend of advertising spending moving online, which benefits the whole sector, including Facebook. That will continue to be an important tailwind for Facebook.
