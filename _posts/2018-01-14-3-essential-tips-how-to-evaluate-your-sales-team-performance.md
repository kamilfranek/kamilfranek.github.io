...
To illustrate my tips with examples, I created data for a fictional sales team and I will use it to visualize and illustrate each approach. To give you more context, let's say that these guys are members of a sales team in a company that produces toys and they focused more on "farming" than "hunting" new customers.
...
The problem lies in the metric I used. I would like to visualize which salespeople are the best and which ones should I celebrate or reward. It might be tempting to say that salesperson who has the biggest revenues, volumes or units sold (Buzz in our example) is the best one, but in most real-life scenarios this easy solution will fail to tell you which of your salespeople is the best because it will be heavily influenced by "potential" of assigned territory or portfolio.
...
Another interesting difference in both leaderboards Mike who jumped significantly up because the potential of his portfolio is significantly smaller than for examples that of Buzz or Rocky. In traditional leaderboard he was hiding in the middle of the field, adjusted leaderboard tells you that he is actually one of your stars an was just unlucky to be assigned smaller portfolio.
...
For analyzing your sales team results, even the adjusted leaderboard is not ideal. We can squeeze far more insight from the data by visualizing it in different ways.
...
## Tip #3: Visualize Your Sales Team Performance vs Peformance Dynamics
...
What I particularly like about this visualisation of your sales team performance is that it helps you to identify the main areas to focus on. 
